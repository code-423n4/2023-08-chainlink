...
interface IMigratable {
  ...
  /// @notice This event is emitted after a 7 day period has passed since a migration target is
  ...
  /// @param principal Amount of LINK deposited
  ...
  /// @notice This function allows the contract owner to accept a proposed migration target address
