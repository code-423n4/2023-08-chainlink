...
- [API Docs](https://github.com/code-423n4/2022-11-chainlink/blob/main/docs/index.md): Autogenerated docs based on inline documentation.
...
> Slither does not currently work due to [this issue](https://github.com/crytic/slither/issues/1407). You can temporarily work around it by commenting out all library events (`emit RewardLib.*()`, `emit StakingPoolLib.*()`) in `Staking.sol` before running Slither.
